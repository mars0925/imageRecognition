...
import matplotlib.pyplot as plt
def plot_images_labels_prediction(images,labels,prediction,idx,num=num_class):
    fig = plt.gcf()
...
plot_images_labels_prediction(x_test_normalize,y_test,prediction,0,num_class)
...
def show_Predicted_Probability(y,prediction,x_img,Predicted_Probability,i):
    ...
    plt.imshow(np.reshape(x_test[i],(32,32)))
    plt.show()
    for j in range(4):
